...
describe('PlaceholderProcessor', () => {
  ...
  it('not resolves relative file path for relative file location', async () => {
    ...
    await expect(
      ...
      'Placeholder $text could not form a URL out of ./a/b/catalog-info.yaml and ../c/catalog-info.yaml, TypeError [ERR_INVALID_URL]: Invalid URL: ./a/b/catalog-info.yaml',
    );
